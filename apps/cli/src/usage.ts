...
configuration, and none of them do without --yes. Metrics and benchmark capture
may write only Token Harness's own local state. Exit codes and JSON are specified
in RFC 0006.`;
