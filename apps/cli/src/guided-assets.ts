...
<section class="setup-step"><div class="step-heading"><span class="step-number">3</span><div><h2>Experimental tools</h2><p>Headroom, mcptoon and GitNexus are being evaluated. Token Harness does not silently install or activate them. Where an exact candidate lifecycle has been reviewed, you can explicitly review that evaluation setup here.</p></div></div><div id="experimental-tools" class="tool-grid"><article class="tool-card experimental"><h3>Checking experimental tools…</h3></article></div></section>
