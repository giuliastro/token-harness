...
- mcptoon selection campaigns now fail closed outside native Linux Codex/Claude surfaces: Windows, macOS, WSL and other harness families must not emit campaign steps or create candidate captures.
